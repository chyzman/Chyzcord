...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Chyzcord");
    ...
    console.log("[Chyzcord] Running in vanilla mode. Not loading Chyzcord");
}

console.log("[Chyzcord] Loading original Discord app.asar");
