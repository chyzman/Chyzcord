...
export const Devs = /* #__PURE__*/ Object.freeze({
  None: {name: "None", id: 0n},
  Ven: {name: "Vee", id: 343383572805058560n},
  Apexo: {name: "Apexo", id: 228548952687902720n},
  Arjix: {name: "ArjixWasTaken", id: 674710789138939916n, badge: false},
  ...
  nick: {name: "nick", id: 347884694408265729n, badge: false},
  ...
  F53: {name: "Cassie (Code)", id: 280411966126948353n},
  ...
  KawaiianPizza: {name: "KawaiianPizza", id: 501000986735673347n},
  zoodogood: {name: "zoodogood", id: 921403577539387454n},
  Max: {name: "Max", id: 1189527130611138663n},
  Fres: {name: "Fres", id: 843448897737064448n},
  Hanzy: {name: "hanzydev", id: 1093131781043126322n},
  VISHNYA_NET_CHERESHNYA: {name: "Vishnya", id: 282541644484575233n},
  Wolfie: {name: "Wolfie", id: 347096063569559553n},
  iamme: {name: "i am me", id: 984392761929256980n},
  MrDiamond: {name: "mrdiamonddog", id: 523338295644782592n},
  Tolgchu: {name: "✨Tolgchu✨", id: 329671025312923648n},
  Slightly: {name: "Slightly", id: 119536078452424704n},
  DaBluLite: {name: "DaBluLite", id: 582170007505731594n},
  Colorman: {name: "colorman", id: 298842558610800650n},
  PWall: {name: "PWall", id: 0n},
  hen: {name: "Hen", id: 279266228151779329n},
  philhk: {name: "philhk", id: 305288513941667851n},
  walrus: {name: "walrus", id: 305317288775778306n},
  Fafa: {name: "Fafa", id: 428188716641812481n},
  Jaegerwald: {name: "Jaegerwald", id: 711944262173982822n},
  SomeAspy: {name: "SomeAspy", id: 516750892372852754n},
  Zoid: {name: "Zoid", id: 854819626969333771n},
  ...
  vbajs: {name: "vbajs", id: 247403343742369794n},
  kyza: {name: "Kyza", id: 220584715265114113n},
  luckycanucky: {name: "luckycanucky", id: 995923917594173440n},
  cooper: {name: "Cooper", id: 594864203102158859n},
...
export const EquicordDevs = Object.freeze({
  nobody: {name: "nobody", id: 0n},
  thororen: {name: "thororen", id: 848339671629299742n},
  nyx: {name: "verticalsync", id: 1207087393929171095n},
  Cortex: {name: "Cortex", id: 825069530376044594n},
  KrystalSkull: {name: "krystalskullofficial", id: 929208515883569182n},
  Naibuu: {name: "hs50", id: 1120045713867423835n},
  Ven: {name: "Vee", id: 343383572805058560n},
  Apexo: {name: "Apexo", id: 228548952687902720n},
  nexpid: {name: "Nexpid", id: 853550207039832084n},
  FoxStorm1: {name: "FoxStorm1", id: 789872551731527690n},
  camila314: {name: "camila314", id: 738592270617542716n},
  ...
  KawaiianPizza: {name: "KawaiianPizza", id: 501000986735673347n},
  Perny: {name: "Perny", id: 1101508982570504244n},
  Jaxx: {name: "Jaxx", id: 901016640253227059n},
  Balaclava: {name: "Balaclava", id: 854886148455399436n},
  dat_insanity: {name: "dat_insanity", id: 0n},
  coolesding: {name: "cooles", id: 406084422308331522n},
  SerStars: {name: "SerStars", id: 861631850681729045n},
  MaxHerbold: {name: "MaxHerbold", id: 1189527130611138663n},
  ...
  bhop: {name: "femeie", id: 442626774841556992n},
  Panniku: {name: "Panniku", id: 703634705152606318n},
  Tolgchu: {name: "✨Tolgchu✨", id: 329671025312923648n},
  DaBluLite: {name: "DaBluLite", id: 582170007505731594n},
  kvba: {name: "kvba", id: 105170831130234880n},
  Fafa: {name: "Fafa", id: 428188716641812481n},
  Colorman: {name: "colorman", id: 298842558610800650n},
  walrus: {name: "walrus", id: 305317288775778306n},
  Prince527: {name: "Prince527", id: 364105797162237952n},
  unstream: {name: "Unstream", id: 1125315673829154837n},
  ThePirateStoner: {name: "ThePirateStoner", id: 1196220620376121381n},
  Sampath: {name: "Sampath", id: 984015688807100419n},
  catcraft: {name: "catcraft", id: 290162449213292546n},
  ShadyGoat: {name: "Shady Goat", id: 376079696489742338n},
  Joona: {name: "Joona", id: 297410829589020673n},
  SimplyData: {name: "SimplyData", id: 301494563514613762n},
  keifufu: {name: "keifufu", id: 469588398110146590n},
  Blackilykat: {name: "Blackilykat", id: 442033332952498177n},
  niko: {name: "niko", id: 341377368075796483n},
  sadan: {name: "sadan", id: 521819891141967883n},
  x3rt: {name: "x3rt", id: 131602100332396544n},
  Hen: {name: "Hen", id: 279266228151779329n},
  Crxa: {name: "Crxa", id: 920290194886914069n},
  vmohammad: {name: "vMohammad", id: 921098159348924457n},
  SpikeHD: {name: "SpikeHD", id: 221757857836564485n},
  bep: {name: "bep", id: 0n},
  llytz: {name: "llytz", id: 1271128098301022240n},
  nin0dev: {name: "nin0dev", id: 886685857560539176n},
  D3SOX: {name: "D3SOX", id: 201052085641281538n},
  newwares: {name: "newwares", id: 421405303951851520n},
  Kyuuhachi: {name: "Kyuuhachi", id: 236588665420251137n},
  ...
  arHSM: {name: "arHSM", id: 841509053422632990n},
  iamme: {name: "i am me", id: 984392761929256980n},
  creations: {name: "Creation's", id: 209830981060788225n},
  Leko: {name: "Leko", id: 108153734541942784n},
  SomeAspy: {name: "SomeAspy", id: 516750892372852754n},
  ...
  vappstar: {name: "vappstar", id: 747192967311261748n},
  ...
  xijexo: {name: "xijexo", id: 1284113557201620995n},
  omaw: {name: "omaw", id: 1155026301791514655n},
  WKoA: {name: "WKoA", id: 724416180097384498n},
  smuki: {name: "sumki", id: 691517398523576331n},
  ItsAlex: {name: "ItsAlex", id: 551023598203043840n},
  Byeoon: {name: "byeoon", id: 1167275288036655133n},
  ...
  VillainsRule: {name: "VillainsRule", id: 0n},
  ...
  nicola02nb: {name: "nicola02nb", id: 257900031351193600n},
  qouesm: {name: "qouesm", id: 130388483494641664n,},
  CallMeGii: {name: "gii", id: 156481332652802048n,},
  mmeta: {name: "mmeta", id: 297075664530440192n},
  SSnowly: {name: "Snowy", id: 1183482753375809537n},
  ZcraftElite: {name: "ZcraftElite", id: 926788037785047050n},
  mart: {name: "mja00", id: 108698087769260032n},
  vei: {name: "Vei", id: 239414094799699968n},
