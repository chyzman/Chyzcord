        ...
        <SettingsTab title="Chyzcord Settings">
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Chyzcord you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure Chyzcord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Chyzcord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
            </Paragraph>
