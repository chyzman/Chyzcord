...
import { getEntryPoint, isPluginFile, parseDevs, parseEquicordDevs, parseChyzcordDevs, parseFile, PluginData } from "./utils";
...
(async () => {
    ...
    if (equicordFlag) {
        ...
        dirs = ["src/plugins", "src/plugins/_core", "src/equicordplugins", "src/chyzcordplugins"];
    }
